...
/**
 * This class corresponds to a SSL control directive which will be delivered by
 * a plugin.
 * 
 * @author ExplodingBottle
 *
 */
public class SSLControlDirective {
	 ...
	 *                         server.
	 */
	public SSLControlDirective(String host, int port, boolean isSSL, HttpRequestHeader outcomingRequest) {
		this.host = host;
		this.port = port;
		this.isSSL = isSSL;
